...
if (isset($_POST['submit'])) {
  ...
  $PhoneNumbar   = mysqli_real_escape_string($conn, $_POST['PhoneNumbar']);
  $Email         = mysqli_real_escape_string($conn, $_POST['Email']);
  $Massage       = mysqli_real_escape_string($conn, $_POST['Massage']);

  // Use prepared statements to insert data into the database
  $stmt = $conn->prepare("INSERT INTO my_table (id , PhoneNumbar, Email, Massage) VALUES (?, ?, ?, ?)");
$stmt->bind_param("ssss", $Name, $PhoneNumbar, $Email, $Massage);
$stmt->execute();
              ...
              <div class="email_box">
                <div class="input_main">
                  <div class="container">
                    ...
                    <div class="form-group">
                      <input type="text" class="email-bt" placeholder="Phone Numbar" name="PhoneNumbar" />
                    </div>
                    <div class="form-group">
                  ...
                  <div class="send_btn">
                    <button class="main_bt" type="submit" name="submit">Send</button>
                  </div>
                </div>
              </div>
            </form>
    	...
    	<div class="container">
    		<div class="mail_section">
    			<div class="row">
    				...
    				<div class="col-sm-6 col-lg-2">
    					<div class="footer-logo"><img src="images/phone-icon.png"><span class="map_text">(212)607662175 </span></div>
    				</div>
